...
function resetPrices() { applyDiscountToPrices(0); }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // СЕКРЕТНАЯ ФУНКЦИЯ ТОЛЬКО ДЛЯ АДМИНА!!!!!!!!!!!
  window.__wheelReset = () => {
    localStorage.removeItem('cine_wheel_ts');
    updateSpinBtn(spinBtn);
    console.log('%c✅ Колесо сброшено!', 'color:#cca43b;font-size:14px;font-weight:bold;');
  };
