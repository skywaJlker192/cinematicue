const FILMS = [
  {
    ...
    image: 'images/strange_things.jpeg',
    year: 2026,
    duration: '5 Сезонов',
    ...
    isNew: true,
    badges: [
      { text: 'Final', cls: 'badge-new' },
      { text: 'Series', cls: 'badge-series' }
    ],
    description:
      'Финальный сезон культового сериала о Хокинсе. Группа подростков сталкивается с последней угрозой из Изнанки — и на этот раз ставки как никогда высоки. Мощная концовка одного из лучших сериалов эпохи стриминга.'
  },
  {
    id: 2,
    ...
    badges: [],
    description:
      'Пол Атрейдес объединяется с Чани и фрименами, чтобы отомстить заговорщикам, уничтожившим его семью. Дени Вильнёв создал эпический шедевр о власти, пророчестве и цене войны. IMAX-зрелище.'
  },
  {
    id: 3,
    title: 'F1',
  ...
  },
  {
    ...
    type: 'series',
    isNew: false,
    badges: [{ text: 'Series', cls: 'badge-series' }],
    description:
      'Жительница убежища выходит на поверхность и попадает в жестокий постъядерный мир. Amazon создал один из лучших адаптационных сериалов в истории — с юмором, экшном и сердцем.'
  },
  {
    id: 5,
    title: 'Оппенгеймер',
    ...
    type: 'movie',
    isNew: false,
    badges: [{ text: '4K', cls: 'badge-res' }],
    description:
      'История создателя атомной бомбы — триумф и моральная трагедия человека, изменившего мир. Кристофер Нолан снял свой самый личный и философский фильм. Три «Оскара».'
  },
  {
    id: 6,
    title: 'Сёгун',
    image: 'images/shogun.webp',
    year: 2024,
    duration: 'Мини-сериал',
    genre: 'Исторический',
    rating: 9.2,
    type: 'series',
    isNew: false,
    badges: [{ text: 'Series', cls: 'badge-series' }],
    description:
      'Европейский мореплаватель оказывается в средневековой Японии в разгар политических интриг. 18 номинаций на «Эмми», победа в 8 категориях.'
  },
  {
    id: 7,
    ...
    year: 2024,
    duration: '1ч 49м',
    genre: 'Военный, Триллер',
    rating: 7.8,
    type: 'movie',
    isNew: false,
    badges: [],
    description:
      'Журналисты пересекают разрывающуюся Америку, чтобы добраться до Белого дома. Провокационный политический триллер о хрупкости демократии и цене правды.'
  },
  {
    id: 8,
    title: 'Медведь',
    ...
    badges: [{ text: 'Series', cls: 'badge-series' }],
    description:
      'Шеф-повар мирового уровня возвращается в Чикаго, чтобы спасти семейный ресторан. Один из самых напряжённых и эмоциональных сериалов современности.'
  },
  {
    id: 9,
    title: 'Фуриоса: Сага',
    image: 'images/furiosa.webp',
    year: 2024,
    duration: '2ч 28м',
    ...
    badges: [],
    description:
      'Происхождение одного из самых культовых персонажей современного кино. Джордж Миллер рассказывает о детстве и становлении Фуриосы в пустошах Безумного Макса.'
  },
  {
    id: 10,
    ...
    type: 'movie',
    isNew: true,
    badges: [{ text: '2025', cls: 'badge-new' }],
    description:
      'Третья глава саги о Пандоре. Семья Салли сталкивается с новой угрозой — огненным народом. Джеймс Кэмерон снова переписывает правила визуальных эффектов.'
  },
  {
    id: 11,
    title: 'Кунг-фу Панда 4',
    image: 'images/panda4.webp',
    year: 2024,
    duration: '1ч 34м',
    genre: 'Мультфильм',
    rating: 7.8,
    ...
    badges: [],
    description:
      'По возвращается с новым приключением, где ему предстоит найти себе преемника. Яркий мультфильм для всей семьи с отличным юмором.'
  },
  {
    id: 12,
    title: 'Годзилла и Конг',
    image: 'images/gk.webp',
    year: 2024,
    duration: '1ч 55м',
    ...
    badges: [],
    description:
      'Годзилла и Конг объединяются против нового колоссального врага из Полой Земли. Максимум монстр-экшна для фанатов серии.'
  },
  {
    id: 13,
    title: 'Каскадеры',
    image: 'images/duble.jpg',
    year: 2024,
    duration: '2ч 06м',
    ...
    badges: [],
    description:
      'Каскадёр вынужден расследовать исчезновение кинозвезды прямо во время съёмок. Дэвид Литч создал любовное письмо людям кино — смешное, зрелищное и трогательное.'
  },
  {
    id: 14,
    title: 'Дэдпул и Росомаха',
    image: 'images/dedpool&wolverine.webp',
    year: 2024,
    duration: '2ч 10м',
    genre: 'Комикс, Экшн',
    rating: 8.2,
    ...
    badges: [],
    description:
      'Дэдпул врывается в киновселенную Marvel вместе с Росомахой. Самый кассовый фильм с рейтингом R в истории — безумный, четвёртостенный и невероятно смешной.'
  },
  {
    id: 15,
    title: 'Одни из нас',
    ...
    isNew: true,
    badges: [
      { text: 'S2', cls: 'badge-new' },
      { text: 'Series', cls: 'badge-series' }
    ],
    description:
      'Второй сезон основан на событиях Part II. История Элли продолжается с ещё большей болью и глубиной. Белла Рэмзи и Кэти Янг — два открытия года.'
  },
  {
    id: 16,
    title: 'Дом Дракона',
    ...
    badges: [{ text: 'Series', cls: 'badge-series' }],
    description:
      'Гражданская война в доме Таргариенов. Танец Дракона — война за Железный трон. Лучший приквел «Игры Престолов» из возможных.'
  },
  {
    id: 17,
    title: 'Задача 3-х тел',
    image: 'images/zadacha.jpg',
    year: 2024,
    duration: '1 Сезон',
    genre: 'Sci-Fi',
    rating: 7.9,
    ...
    badges: [{ text: 'Series', cls: 'badge-series' }],
    description:
      'Адаптация трилогии Лю Цысиня от создателей «Игры Престолов». Физик обнаруживает, что человечество получило послание из космоса — и оно не несёт добра.'
  },
  {
    id: 18,
    title: 'Пацаны',
    image: 'images/boys.webp',
    year: 2024,
    duration: '4 Сезона',
    genre: 'Экшн, Сатира',
    rating: 8.7,
    ...
    badges: [{ text: 'Series', cls: 'badge-series' }],
    description:
      'Группа простых людей противостоит продажным супергероям-корпоратам. Самая злая, смешная и актуальная сатира на супергеройское кино и современное общество.'
  },
  {
    id: 19,
    title: 'Барби',
    ...
    badges: [],
    description:
      'Барби и Кен отправляются в реальный мир. Грета Гервиг создала постмодернистский шедевр, который смешит, трогает и заставляет думать одновременно.'
  },
  {
    id: 20,
    title: 'Головоломка 2',
    image: 'images/insideout2.webp',
    year: 2024,
    duration: '1ч 40м',
    genre: 'Мультфильм',
    rating: 8.4,
    ...
    badges: [],
    description:
      'Райли 13 лет — и к старым эмоциям присоединяется тревога. Pixar на пике формы: глубокий, смешной и точный фильм о подростковом взрослении.'
  },
  {
    id: 21,
    title: 'Человек-паук: Паутина',
    ...
    badges: [],
    description:
      'Майлз Моралес путешествует по мультивселенной и встречает армию Людей-пауков. Sony переизобрела анимационное кино — каждый кадр как произведение искусства.'
  }
];
...
function saveRecent() {
  localStorage.setItem('cine_recent', JSON.stringify(recentlyViewed));
}
...
function renderCatalog(films) {
  ...
  if (counter)
    counter.textContent = films.length > 0 ? `(${films.length})` : '';
  if (!films.length) {
    grid.innerHTML =
      '<p class="no-results"><i class="fas fa-film"></i> По запросу ничего не найдено</p>';
    return;
  }
...
function applyFilter(filter) {
  activeFilter = filter;
  document
    .querySelectorAll('.js-filter-btn')
...
function toggleWishlist(id) {
  ...
  if (wasIn) {
    delete wishlist[id];
    showToast(`«${film.title}» убран из избранного`, 'remove');
  } else {
    wishlist[id] = film;
  ...
  if (cardBtn) {
    ...
    cardBtn.querySelector('i').className = inW
      ? 'fas fa-heart'
      : 'far fa-heart';
  }
...
function renderWishlistModal() {
  ...
  if (!items.length) {
    list.innerHTML =
      '<p class="wishlist-empty">Избранное пусто — добавьте фильмы нажав ♥ на карточке</p>';
    total.textContent = '';
    return;
  }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('sort-select')?.addEventListener('change', (e) => {
    ...
    else renderCatalog(getFilteredSortedFilms());
  });

  // поиск
  document
    .querySelector('.poda-input')
  ...
  grid.addEventListener('click', (e) => {
    ...
    if (trigger) {
      openFilmModal(trigger.dataset.id);
      return;
    }
    const wBtn = e.target.closest('.wishlist-btn');
    if (wBtn) {
      toggleWishlist(wBtn.dataset.id);
      return;
    }
  });
  ...
  document
    ...
    ?.addEventListener('click', openWishlistModal);

  // «Мне повезёт»
  document
    .getElementById('btn-lucky')
    ?.addEventListener('click', openRandomFilm);

  // избранное в модалке фильма
  document
    .getElementById('modal-wishlist-btn')
  ...
  // закрытие модалок
  document
    .getElementById('film-modal-close')
    ?.addEventListener('click', closeFilmModal);
  document.getElementById('film-modal')?.addEventListener('click', (e) => {
    if (e.target.id === 'film-modal') closeFilmModal();
  });
  document
    .getElementById('wishlist-modal-close')
